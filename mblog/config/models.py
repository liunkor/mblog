...
class Link(models.Model):
    ...
    href = models.URLField(verbose_name='链接') # the default length is 200 char
...
class SideBar(models.Model):
    ...
    content = models.CharField(max_length=512, blank=True, verbose_name='内容',
                               help_text='如果设置的不是HTML类型，可为blank')
    ...
    def content_html(self):
        ...
        if self.display_type == self.DISPLAY_HTML:
            ...
            context = {'comments': Comment.ojects.filter(status=Comment.STATUS_NORMAL)}
